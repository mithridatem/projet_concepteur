...
<body>
    ...
    <h1 class="text-center text-2xl text-gray-700 mt-20"><?= $content_title?> <span class=" z-20 before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-blue-800 relative inline-block "><span class="relative text-white"><?=$title?></span> </span></h1>
