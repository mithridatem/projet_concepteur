...
<body class="relative">
    ...
    <form action="" class="justify-center flex " method="POST" enctype="multipart/form-data">
        <div class="mt-8 w-3/5 flex">
            <div class="grid grid-cols-1 gap-6 w-2/4">
                <label class="block">
                ...
                <input type="submit" value="submit" class="rounded-full bg-blue-800 text-white h-10 w-1/3 mx-auto" name="submit" />
            </div>
            <div class="w-2/4">
